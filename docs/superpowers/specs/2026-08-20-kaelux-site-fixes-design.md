...
Apply four focused homepage fixes without changing the existing page structure or visual system:
...
- Do not change RAG ingestion, Redis configuration, rate limiting, or the intake system prompt.
